# نظام التشغيل التربوي — P2

**الحالة: P2 مكتمل، وP3 لم يبدأ.**

مشروع Next.js App Router وTypeScript لإعداد البرامج وتشغيل جلساتها. يدعم قوالب البرامج، الخطط والدفعات والمجموعات، ثم توليد الجلسات وفتحها وتجميد الكشف وتسجيل الحضور والمعايير والحفظ الجزئي والإغلاق والتصحيح التاريخي. تعمل الطلبات عبر مستخدم PostgreSQL محدود مع RLS إجباري.
