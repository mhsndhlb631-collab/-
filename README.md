# نظام التشغيل التربوي — P4

**الحالة: P4 مكتمل، وP5 لم يبدأ.**

مشروع Next.js App Router وTypeScript لإعداد البرامج وتشغيل جلساتها وتتبع تقدم الطلاب. يدعم القوالب والخطط والدفعات والمجموعات، والجلسات والحضور، والأوراد والعادات، والمحتوى والتكليفات والاختبارات والتقييم الذاتي وملخص الأسبوع المعتمد. تحفظ التصحيحات والاعتمادات كسجل نسخ تاريخي. تعمل الطلبات عبر مستخدم PostgreSQL محدود مع RLS إجباري.
