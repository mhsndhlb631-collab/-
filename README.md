...
مشروع Next.js App Router وTypeScript، مع مخطط PostgreSQL أولي واختبارات محلية. لم يُنشأ مشروعا Supabase وVercel بعد. توجد خدمات محلية خلف واجهات لاختبار إنشاء الحساب والتعطل والاستئناف وإعادة التعيين وتسجيل الدخول، لكن لا يوجد مسار دخول عام متاح حاليًا؛ فتحه يعتمد على اجتياز تجربة إبطال الجلسات في Supabase الحقيقي وربط المستودعات الفعلية.
