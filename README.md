...
مشروع Next.js App Router وTypeScript، مع مخطط PostgreSQL أولي واختبارات محلية. لم يُنشأ مشروعا Supabase وVercel بعد. تسجيل الدخول وإدارة الحسابات غير متاحين حاليًا؛ يعتمد تنفيذهما على اجتياز تجربة إبطال الجلسات في Supabase الحقيقي.
