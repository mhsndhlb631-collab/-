# نظام التشغيل التربوي — P4.1

**الحالة: P4.1 مغلقة، وP5 لم يبدأ.**

مشروع Next.js App Router وTypeScript لإعداد البرامج وتشغيل جلساتها وتتبع تقدم الطلاب. يدعم القوالب والخطط والدفعات والمجموعات، والجلسات والحضور، والأوراد والعادات، والمحتوى والتكليفات والاختبارات والتقييم الذاتي وملخص الأسبوع النهائي تلقائيًا. تحفظ التصحيحات ولقطات الإغلاق كسجل نسخ تاريخي. تعمل الطلبات عبر مستخدم PostgreSQL محدود مع RLS إجباري.
