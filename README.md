...
مشروع Next.js App Router وTypeScript لإعداد البرامج وتشغيل جلساتها وتتبع تقدم الطلاب. يدعم القوالب والخطط والدفعات والمجموعات، والجلسات والحضور، والتتبع، والمحتوى والتكليفات والاختبارات، والمتابعة والحالات، وقياس أداء المربين والتقارير. تضم واجهة المسؤول رحلة بدء واضحة لإضافة الطلاب والمربين، وتوزيعهم، وفتح الجلسات وتسجيل الحضور والمعايير، وإضافة محتوى وتكاليف واختبارات إلى أسابيع الدفعة. تكمل P7 رحلات المسؤول والمربي والطالب بصفحات اليوم والبرنامج والتقدم، وتنقل مخصص للدور، وتغيير كلمة المرور والخروج، وتجربة عربية RTL متجاوبة ويمكن تشغيلها بلوحة المفاتيح. تعمل الطلبات عبر مستخدم PostgreSQL محدود مع RLS إجباري.
