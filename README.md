...
**الحالة: P0 مكتمل، وP1 جاهز للتصريح الصريح ولم يبدأ.**

مشروع Next.js App Router وTypeScript، مع مخطط PostgreSQL تأسيسي وخدمات حسابات مختبرة. طُبقت migrations على Supabase الحقيقي، واجتاز مستخدم التشغيل المحدود اختبارات الجلسات وRLS والأدوار والعزل. مسار الدخول العام على Vercel يقبل اسم الدخول وكلمة المرور فقط، ويضع الرموز في Cookies محمية دون كشف البريد التقني.
