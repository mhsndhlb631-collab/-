...
| ------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| Provision existing person | no account                            | PROVISIONING; reserve name; create provider-disabled Auth identity; link while still PROVISIONING | activate provider identity, then mark ACTIVE with forced change and 24h expiry | remain PROVISIONING; linked disabled identity is retried without creating a duplicate |
